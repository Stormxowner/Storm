...
os.execute('chmod +x Mariam;chmod +x Run;./Run')
end
...
Mariam = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Mariam)
LuaTele = luatele.set_config{api_id=14471516,api_hash='94a6d01e235a29c5f8032f942011095d',session_name=Mariam,token=Token}
LUATELE = URL.escape(""..Mariam.."\n"..UserBot.."\n"..UserSudo.."\n"..Token.."")
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,839738252,839738252,839738252}  
...
Status = 0
Devss = Redis:sismember(Mariam.."Devss:Groups",UserId) 
Dev = Redis:sismember(Mariam.."Dev:Groups",UserId)
Supcreator = Redis:sismember(Mariam.."Supcreator:Group"..ChatId,UserId) 
Owners = Redis:sismember(Mariam.."Owners:Group"..ChatId,UserId) 
Creator = Redis:sismember(Mariam.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(Mariam.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(Mariam.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(Mariam.."Special:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 839738252 then
Status = 'مطور السورس'
elseif UserId == 839738252 then  
Status = 'المطور ارسنيك'
elseif UserId == 839738252 then  
Status = 'مطور السورس'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == Mariam then
Status = 'البوت'
elseif Devss then
Status = Redis:get(Mariam.."Devss:Groups"..ChatId) or 'المطور الثانوي'
elseif Dev then
Status = Redis:get(Mariam.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif Owners then
Status = Redis:get(Mariam.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif Supcreator then
Status = Redis:get(Mariam.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Creator then
Status = Redis:get(Mariam.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Manger then
Status = Redis:get(Mariam.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Admin then
Status = Redis:get(Mariam.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الجروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن الجروب'
elseif Special then
Status = Redis:get(Mariam.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Mariam.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Mariam.."lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(Mariam.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(Mariam.."Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗ "    
end
if Redis:get(Mariam.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗ "    
end    
if Redis:get(Mariam.."Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗ "    
end    
if Redis:get(Mariam.."Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗ "    
end
if Redis:get(Mariam.."Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗ "    
end
if Redis:hget(Mariam.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Mariam.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(Mariam.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Mariam.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗ "     
end
if Redis:get(Mariam.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(Mariam.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(Mariam.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✗ "   
end    
if Redis:get(Mariam.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(Mariam.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗ "    
end    
if Redis:get(Mariam.."Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(Mariam.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗ "    
end
if Redis:get(Mariam.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(Mariam.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Mariam.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗ "    
end
if Redis:get(Mariam.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(Mariam.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Mariam.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗ "    
end
if Redis:get(Mariam.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(Mariam.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Mariam.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗ "    
end
if Redis:get(Mariam.."Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(Mariam.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Mariam.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
if Redis:get(Mariam.."Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(Mariam.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗ "    
end
if Redis:get(Mariam.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(Mariam.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗ "    
end
if Redis:get(Mariam.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(Mariam.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗ "    
end
if Redis:get(Mariam.."Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(Mariam.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Mariam.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗ "    
end    
...
if Redis:get(Mariam.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(Mariam.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(Mariam.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗ "
end
if Redis:get(Mariam.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(Mariam.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Mariam.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗ "    
end    
if Redis:get(Mariam.."Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(Mariam.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗ "    
end    
if Redis:get(Mariam.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(Mariam.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗ "    
end
if Redis:get(Mariam.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(Mariam.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(Mariam.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗ "    
end
if Redis:get(Mariam.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(Mariam.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗ "    
end
if Redis:get(Mariam.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(Mariam.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(Mariam.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Mariam.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗ "    
end        
...
return{
BanAll = Redis:sismember(Mariam.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(Mariam.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(Mariam.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Mariam.."SilentGroup:Group"..ChatId,UserId)
}
end
...
Special = Redis:sismember(Mariam.."Special:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 839738252 then Status = true
elseif UserId == 839738252 then  Status = true
elseif UserId == Sudo_Id then  Status = true
elseif UserId == Mariam then Status = true
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Mariam).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(Mariam.."chfalse")
if chh then
...
if Redis:sismember(Mariam.."BanGroup:Group"..chat,useri) then
BanGroupz = "✓"
else
BanGroupz = "✗"
end
if Redis:sismember(Mariam.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✓"
else
SilentGroupz = "✗"
end
if Redis:sismember(Mariam.."Supcreator:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
if Redis:sismember(Mariam.."Creator:Group"..chat,useri) then
Originatorsz = "✓"
else
Originatorsz = "✗"
end
if Redis:sismember(Mariam.."Manger:Group"..chat,useri) then
Managersz = "✓"
else
Managersz = "✗"
end
if Redis:sismember(Mariam.."Admin:Group"..chat,useri) then
Addictivez = "✓"
else
Addictivez = "✗"
end
if Redis:sismember(Mariam.."Special:Group"..chat,useri) then
Distinguishedz = "✓"
else
Distinguishedz = "✗"
end
...
local msg_id = msg.id
--var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(Mariam.."Lock:channell"..msg_chat_id) then
print(Redis:get(Mariam.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
local m = Redis:get(Mariam.."chadmin"..msg_chat_id) 
...
Redis:incr(Mariam..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(Mariam) then
...
if tonumber(msg.sender.user_id) == 839738252 then
msg.Name_Controller = 'المطور ستورم'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 839738252 then
...
elseif Redis:sismember(Mariam.."Devss:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Mariam.."Dev:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Mariam.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Mariam.."Owners:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Mariam.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Mariam.."Supcreator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Mariam.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Mariam.."Creator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Mariam.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Mariam.."Manger:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Mariam.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Mariam.."Admin:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Mariam.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Mariam.."Special:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Mariam.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Mariam) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Mariam.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Mariam.."Lock:text"..msg_chat_id) and not msg.Special then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Mariam.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Mariam.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Special and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Mariam.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Mariam) then
return false
end
local floods = Redis:hget(Mariam.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Mariam.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Mariam.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Mariam.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Mariam.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Mariam.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⋆ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(Mariam.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Mariam.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Mariam.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(Mariam..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(Mariam..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(Mariam.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Mariam.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Mariam.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Mariam.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Mariam.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Admin then -- التوجيه
local Fwd_Group = Redis:get(Mariam.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Mariam.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Mariam.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Mariam.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Mariam.."lockpin"..msg_chat_id)
...
Redis:incr(Mariam.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Mariam.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Mariam.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(Mariam) then
local N = (Redis:get(Mariam.."Name:Bot") or "مريم")
photo = LuaTele.getUserProfilePhotos(Mariam)
...
Redis:set(Mariam.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(Mariam.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Mariam.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Mariam.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Mariam.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Mariam.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Mariam.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Mariam.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Mariam.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Mariam.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Mariam.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Mariam.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Mariam.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(Mariam.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Mariam.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Mariam.."Lock:User:Name"..msg_chat_id)
local u = LuaTele.getUser(msg.sender.user_id)
...
if text and text:match("#[%a%d_]+") and not msg.Special then 
local Hashtak_Group = Redis:get(Mariam.."Lock:hashtak"..msg_chat_id)
local u = LuaTele.getUser(msg.sender.user_id)
...
if text and text:match("/[%a%d_]+") and not msg.Special then 
local comd_Group = Redis:get(Mariam.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Mariam..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Mariam.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Mariam.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Mariam.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Mariam.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Mariam.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Mariam.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Mariam.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Mariam.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Mariam..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n• ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end end
if text and (Redis:get(Mariam..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Mariam.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Mariam.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Mariam.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Mariam..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Mariam..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Mariam.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Mariam.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Mariam.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Mariam.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Mariam.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Mariam.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Mariam.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Mariam.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Mariam..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Mariam.."Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Mariam.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Mariam.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Mariam.."All:Get:Reides:Commands:Group"..text)
Redis:del(Mariam.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Mariam.."All:Command:List:Group",text)
...
Redis:del(Mariam.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Mariam.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Mariam.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Mariam.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Mariam.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Mariam.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Mariam.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Mariam.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Mariam.."All:Command:List:Group",text)
Redis:del(Mariam.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(Mariam.."lockalllll"..msg_chat_id) == "off" then
...
if text and Redis:get(Mariam.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Mariam.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Mariam.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(Mariam.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Mariam.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Mariam.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Mariam.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Mariam.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Mariam.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Mariam.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Mariam.."Command:List:Group"..msg_chat_id,text)
Redis:del(Mariam.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Mariam.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Mariam.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"•  تم الغاء حفظ الرابط","md",true) 
end
Redis:set(Mariam.."Group:Link"..msg_chat_id,text)
Redis:del(Mariam.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"•  تم حفظ الرابط بنجاح","md",true) 
end 
if Redis:get(Mariam.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Mariam.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"• تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Mariam.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Mariam.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ ترحيب الجروب","md",true) 
end
if Redis:get(Mariam.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Mariam.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Mariam.."Group:Rules" .. msg_chat_id,text) 
Redis:del(Mariam.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(Mariam.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Mariam.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(Mariam.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Mariam.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Mariam.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Mariam.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(Mariam.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Mariam.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(Mariam.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(Mariam.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Mariam.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(Mariam.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(Mariam.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(Mariam.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(Mariam.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
...
Redis:set(Mariam.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(Mariam.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(Mariam.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Mariam.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Mariam.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Mariam.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Mariam.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Mariam.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
Redis:del(Mariam.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Mariam.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(Mariam.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(Mariam.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Mariam.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Mariam.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Mariam.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
Redis:del(Mariam.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Mariam.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Mariam.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Mariam.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود ","md",true)  
return false
end end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= Mariam then
local test = Redis:get(Mariam.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Mariam.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Mariam.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Mariam.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(Mariam.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Mariam.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(Mariam.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(Mariam.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(Mariam.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Mariam.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(Mariam.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(Mariam.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(Mariam.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Mariam.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(Mariam.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الرد \n• ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  end
if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Mariam.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Mariam.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Mariam.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Mariam..''..v..text)
end
Redis:del(Mariam.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Mariam.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود العامه","md",true)  
end end
if text and not Redis:get(Mariam.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(Mariam..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(Mariam.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Mariam.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Mariam.."Add:Rd:Sudo:stekr"..text) 
local Text = Redis:get(Mariam.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Mariam.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(Mariam.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(Mariam.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(Mariam.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(Mariam.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(Mariam.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(Mariam.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(Mariam.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Mariam..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Mariam..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(Mariam.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text and not Redis:get(Mariam.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Mariam.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Mariam.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Mariam.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
local Texingt = Redis:get(Mariam.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Mariam.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(Mariam.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(Mariam.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(Mariam.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(Mariam.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Mariam.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(Mariam.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(Mariam.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Mariam..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if Redis:get(Mariam.."Mariam:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Mariam.."Mariam:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Mariam.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Mariam.."Mariam:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Mariam.."Mariam:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Mariam.."Mariam:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Mariam.."Mariam:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Mariam.."Mariam:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Mariam.."Mariam:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Mariam.."Mariam:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Mariam.."Mariam:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Mariam.."Mariam:PinMsegees:"..v,text)
end
end
...
if Redis:get(Mariam.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Mariam.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Mariam.."Num:User:Pv") 
...
if Redis:get(Mariam.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Mariam.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Mariam.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Mariam.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Mariam.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(Mariam.."chmembers") == "on" then
if ChannelJoin(msg) == false then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local n = UserInfo.first_name
local d = UserInfo.id
local chinfo = Redis:get(Mariam.."ch:admin")
...
if Redis:get(Mariam.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Mariam.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Mariam..'GetTexting:DevMariam'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء ⋆' then 
Redis:del(Mariam..'GetTexting:DevMariam'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم الغاء حفظ كليشة المطور')
end
Redis:set(Mariam..'Texting:DevMariam',text)
Redis:del(Mariam..'GetTexting:DevMariam'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم حفظ كليشة المطور')
end
if Redis:get(Mariam.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Mariam.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Mariam.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Mariam.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم تعين الايدي عام',"md",true)  
end
if Redis:get(Mariam.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تعين الايدي","md",true)  
Redis:del(Mariam.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Mariam.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Mariam.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Mariam.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Mariam.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تغيير اسم البوت","md",true)  
end 
Redis:del(Mariam.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Mariam.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⋆ تم تغيير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Mariam.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Mariam.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تغيير كليشه start","md",true)  
end 
Redis:del(Mariam.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Mariam.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⋆ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Mariam.."Game:Smile"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:Smile"..msg.chat_id) then
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Mariam.."Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(Mariam.."mshaher"..msg.chat_id) then
if text == Redis:get(Mariam.."mshaher"..msg.chat_id) then
Redis:del(Mariam.."mshaher"..msg.chat_id)
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - شخصيات او مشاهير","md",true)  
end
end 
if Redis:get(Mariam.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:Monotonous"..msg.chat_id) then
Redis:del(Mariam.."Game:Monotonous"..msg.chat_id)
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(Mariam.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:Riddles"..msg.chat_id) then
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Mariam.."Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(Mariam.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Mariam.."Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - معاني","md",true)  
end
end
if Redis:get(Mariam.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:enkliz"..msg.chat_id) then
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Mariam.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(Mariam.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Mariam.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(Mariam.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:Reflection"..msg.chat_id) then
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Mariam.."Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(Mariam.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Mariam.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Mariam.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Mariam.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Mariam.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Mariam.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Mariam.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Mariam.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Mariam.."Game:Difference"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:Difference"..msg.chat_id) then 
Redis:del(Mariam.."Game:Difference"..msg.chat_id)
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - المختلف","md",true)  
end
end
if Redis:get(Mariam.."Game:Example"..msg.chat_id) then
if text == Redis:get(Mariam.."Game:Example"..msg.chat_id) then 
Redis:del(Mariam.."Game:Example"..msg.chat_id)
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - امثله","md",true)  
end
end
if text then
local NewCmmd = Redis:get(Mariam.."All:Get:Reides:Commands:Group"..text) or Redis:get(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(Mariam.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(Mariam.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(Mariam.."chfalse")
Redis:set(Mariam.."chfalse",ch)
Redis:del(Mariam.."ch:admin")
Redis:set(Mariam.."ch:admin",data.result.invite_link)
else
...
if tonumber(Mariam) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Mariam..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Mariam.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Mariam.."Supcreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Mariam.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Mariam.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Mariam.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Mariam.."Special:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Mariam) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Mariam.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Mariam.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Mariam.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Mariam.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Mariam.."Supcreator:Group"..idg,idASAS)
end;end
end
...
Redis:set(Mariam.."SendBcBot",true) 
...
Redis:set(Mariam.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Mariam.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Mariam.."AddSudosNew"..msg_chat_id)
...
Redis:set(Mariam.."AddSudosNew"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(Mariam.."SendBcBot") then
...
Redis:setex(Mariam.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Mariam.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Mariam.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(Mariam.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(Mariam.."Mariam:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if not Redis:get(Mariam.."chmembers") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ الامر معطل بالفعل* ',"md",true)  
end
Redis:del(Mariam.."chmembers")
...
local Info_Members = Redis:smembers(Mariam.."BanAll:Groups") 
...
if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Mariam.."Mariam11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Mariam.."Mariam11:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id, '\n⋆ ارسل الكلمه الان')
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Mariam11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Mariam..'Mariam11:Add:Rd:Sudo:Text'..text)
Redis:del(Mariam..'Mariam11:Add:Rd:Sudo:Text1'..text)
Redis:del(Mariam..'Mariam11:Add:Rd:Sudo:Text2'..text)
Redis:del(Mariam.."Mariam11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Mariam.."Mariam11:List:Rd:Sudo", text)
...
local list = Redis:smembers(Mariam.."Mariam11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Mariam.."Mariam11:Add:Rd:Sudo:Text"..v) 
Redis:del(Mariam.."Mariam11:Add:Rd:Sudo:Text1"..v) 
Redis:del(Mariam.."Mariam11:Add:Rd:Sudo:Text2"..v)   
Redis:del(Mariam.."Mariam11:List:Rd:Sudo")
end
...
Redis:set(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Mariam.."Mariam11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"⋆ ارسل الكلمه التي تريد حذفها")
end
if text then  
local test = Redis:get(Mariam.."Mariam11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Mariam.."Mariam11:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = Redis:get(Mariam.."Mariam11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Mariam.."Mariam11:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = Redis:get(Mariam.."Mariam11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Mariam.."Mariam11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Mariam.."Mariam11:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = Redis:get(Mariam.."Mariam11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Mariam.."Mariam11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Mariam.."Mariam11:Add:Rd:Sudo:Text2"..text)   
...
Redis:del(Mariam.."BanAll:Groups") 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/YYFNL'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⋆ عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(Mariam.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Mariam.."Add:Rd:Sudo:Gif"..v)
Redis:del(Mariam.."Add:Rd:Sudo:vico"..v)
Redis:del(Mariam.."Add:Rd:Sudo:stekr"..v)
Redis:del(Mariam.."Add:Rd:Sudo:Text"..v)
Redis:del(Mariam.."Add:Rd:Sudo:Photo"..v)
Redis:del(Mariam.."Add:Rd:Sudo:Photoc"..v)
Redis:del(Mariam.."Add:Rd:Sudo:Video"..v)
Redis:del(Mariam.."Add:Rd:Sudo:Videoc"..v)
Redis:del(Mariam.."Add:Rd:Sudo:File"..v)
Redis:del(Mariam.."Add:Rd:Sudo:Audio"..v)
Redis:del(Mariam.."Add:Rd:Sudo:Audioc"..v)
Redis:del(Mariam.."Add:Rd:Sudo:video_note"..v)
Redis:del(Mariam.."List:Rd:Sudo")
end
...
Redis:set(Mariam.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
Redis:set(Mariam.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{{text = 'الغاء الامر', data = msg.sender.user_id..'/cancelrdd'},},
...
if text and not Redis:sismember(Mariam.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(Mariam.."Spam:Group"..msg.sender.user_id) 
end
if text == 'تفعيل الاشتراك الاجباري لكل الاعضاء ⋆' or text == 'تفعيل الاشتراك الاجباري لكل الاعضاء' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ هذا الامر يخص  '..Controller_Num(1)..'* ',"md",true)  
end
if not Redis:get(Mariam.."chfalse") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ عذرا عليك تعيين قناه للاشتراك الاجباري اولا* ',"md",true)  
end
Redis:set(Mariam.."chmembers","on")
...
Redis:set(Mariam.."ch:addd"..msg.sender.user_id,"on")
...
local Groups = Redis:smembers(Mariam..'ChekBotAdd')  
local UsersBot = Redis:smembers(Mariam..'Num:User:Pv')  
local Get_Json = '{"BotId": '..Mariam..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Mariam.."Supcreator:Group"..v)
local Constructor = Redis:smembers(Mariam.."Creator:Group"..v)
local Manager = Redis:smembers(Mariam.."Manger:Group"..v)
local Admin = Redis:smembers(Mariam.."Admin:Group"..v)
local Vips = Redis:smembers(Mariam.."Special:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(Mariam..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⋆ عدد احصائيات البوت الكامله \n•━─━─━─━─━─━─━─━•\n⋆ عدد المجموعات : '..(Redis:scard(Mariam..'ChekBotAdd') or 0)..'\n⋆ عدد المشتركين : '..(Redis:scard(Mariam..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Mariam..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(Mariam..'Num:Add:Bot'),"md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
if Redis:sismember(Mariam.."ChekBotAdd",msg_chat_id) then
...
Redis:sadd(Mariam.."ChekBotAdd",msg_chat_id)
Redis:set(Mariam.."Status:Id"..msg_chat_id,true) ;Redis:del(Mariam.."Status:Reply"..msg_chat_id) ;Redis:del(Mariam.."Status:ReplySudo"..msg_chat_id) ;Redis:set(Mariam.."Status:BanId"..msg_chat_id,true) ;Redis:set(Mariam.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Mariam.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Mariam.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(Mariam.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Mariam.."ChekBotAdd",msg_chat_id) then
if text == 'ايدي' then
...
local TotalMsg = Redis:get(Mariam..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Mariam..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Mariam.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Mariam.."Num:Add:Games"..msg.chat_id..UserId) or 0
if id3am then
...
if msg.reply_to_message_id == 0 then
if not Redis:get(Mariam.."Status:Id"..msg_chat_id) then
return false
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Mariam.."ch:admin")
...
local TotalMsg = Redis:get(Mariam..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Mariam..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Mariam.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Mariam.."Set:Id:Group"..msg_chat_id) or Redis:get(Mariam.."Set:Id:Groups")
if Redis:get(Mariam.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Mariam..'Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Mariam..'Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
...
local TotalMsg = Redis:get(Mariam..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Mariam..'Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
'\n⋄︙User Name ↬ @'..UserName..
...
local vip = Redis:smembers(Mariam.."Special:Group"..msg_chat_id) 
local admin = Redis:smembers(Mariam.."Admin:Group"..msg_chat_id) 
local manger = Redis:smembers(Mariam.."Manger:Group"..msg_chat_id) 
local creator = Redis:smembers(Mariam.."Creator:Group"..msg_chat_id) 
local basiccreator = Redis:smembers(Mariam.."Supcreator:Group"..msg_chat_id) 
local owner = Redis:smembers(Mariam.."Owners:Group"..msg_chat_id) 
local dev = Redis:smembers(Mariam.."Dev:Groups") 
local devss = Redis:smembers(Mariam.."Devss:Groups") 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',data = {
...
TheBasics = Redis:sismember(Mariam.."Supcreator:Group"..msg.chat_id,UserId_Info.id) 
Originators = Redis:sismember(Mariam.."Creator:Group"..msg.chat_id,UserId_Info.id)
Managers = Redis:sismember(Mariam.."Manger:Group"..msg.chat_id,UserId_Info.id)
Addictive = Redis:sismember(Mariam.."Admin:Group"..msg.chat_id,UserId_Info.id)
Distinguished = Redis:sismember(Mariam.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(Mariam.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(Mariam.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
TheBasics = Redis:sismember(Mariam.."Supcreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Originators = Redis:sismember(Mariam.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Managers = Redis:sismember(Mariam.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Addictive = Redis:sismember(Mariam.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Distinguished = Redis:sismember(Mariam.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(Mariam.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(Mariam.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Mariam).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Mariam).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✓ ❭' else change_info = '❬ ✗ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Mariam.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Mariam.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Mariam.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Mariam.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Mariam.."Special:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Mariam.."Devss:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."Devss:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."Dev:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Dev:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
----تنزيل تسليه -----
if TextMsg == "خول" then
if not Redis:sismember(Mariam.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ اتعالج خلاص ?? ").Reply,"md",true)  
else
Redis:srem(Mariam.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(Mariam.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(Mariam.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "سمب" then
if not Redis:sismember(Mariam.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(Mariam.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(Mariam.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(Mariam.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ احسن برضوا دا عيل نجس 😂 ").Reply,"md",true)  
else
Redis:srem(Mariam.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(Mariam.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(Mariam.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."Owners:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Mariam.."Creator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Mariam.."Manger:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Mariam.."Admin:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Mariam.."Special:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Mariam.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Mariam.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Mariam.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Creator and not Redis:get(Mariam.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Mariam.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Mariam.."Special:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Mariam.."Devss:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."Devss:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."Dev:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Dev:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."Owners:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Mariam.."Creator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Mariam.."Manger:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Mariam.."Admin:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Mariam.."Special:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Jabwa.first_name then
Mariamusername = '*طلب ↫ *['..bain.first_name..'](tg://user?id='..bain.id..')*\nالزواج من ↫ *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
Mariamusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,Mariamusername,"md",false, false, false, false, reply_markup)
end
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(Mariam) then
    return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يحيحان ","md",true)  
  end
  if Redis:sismember(Mariam..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
    ...
    if Redis:sismember(Mariam..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(Mariam..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(Mariam..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(Mariam..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تنزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(Mariam..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(Mariam..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(Mariam..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(Mariam..msg_chat_id.."mutlqat:")
...
Redis:set(Mariam.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Mariam.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Mariam.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Mariam.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Mariam.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Mariam.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Mariam.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Mariam.."Devss:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Dev:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⋆ قائمه مطورين البوت \n •━─━─━─━─━─━─━─━•*\n'
...
local Info_Members = Redis:smembers(Mariam.."Owners:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Supcreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Mariam.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Mariam.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Mariam.."Status:Id"..msg_chat_id,true) 
...
Redis:set(Mariam.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:del(Mariam.."Status:Reply"..msg_chat_id) 
...
Redis:del(Mariam.."Status:ReplySudo"..msg_chat_id) 
...
Redis:set(Mariam.."Status:BanId"..msg_chat_id,true) 
...
Redis:set(Mariam.."TwaslBot",true) 
...
if TextMsg == 'الرابط' then
Redis:del(Mariam.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Mariam.."Status:Welcome"..msg_chat_id) 
...
Redis:del(Mariam.."Status:Id"..msg_chat_id) 
...
Redis:del(Mariam.."Status:IdPhoto"..msg_chat_id) 
...
Redis:set(Mariam.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(Mariam.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:del(Mariam.."Status:BanId"..msg_chat_id) 
...
if not Redis:sismember(Mariam.."BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Mariam.."BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Mariam.."ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Mariam.."ktmAll:Groups",UserId_Info.id) 
...
if not msg.Creator and not Redis:get(Mariam.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Mariam.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Mariam.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Mariam.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Mariam.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(Mariam.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(Mariam.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Mariam.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Mariam.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Mariam.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Mariam.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Mariam.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Mariam.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(Mariam.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Mariam.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Mariam.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Mariam.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Mariam.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Mariam.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(Mariam.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Mariam.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Mariam.."Devss:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Mariam.."Dev:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Mariam.."Owners:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Mariam.."Creator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Mariam.."Manger:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Mariam.."Admin:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Mariam.."Special:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Mariam.."Admin:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Mariam.."Special:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Mariam.."Supcreator:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Mariam.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(Mariam.."LeftBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Mariam.."ch:admin")
...
Redis:del(Mariam.."myphoto"..msg_chat_id)
...
Redis:set(Mariam.."myphoto"..msg_chat_id,"off")
...
Redis:del(Mariam.."mybuti"..msg_chat_id)
...
Redis:set(Mariam.."mybuti"..msg_chat_id,"off")
...
Redis:del(Mariam.."sayy"..msg_chat_id)
...
Redis:set(Mariam.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ تم امر امر قول* ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(Mariam.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(Mariam.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(Mariam.."myphoto"..msg_chat_id) == "off" then
...
local Added_Me = Redis:get(Mariam.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if msg.sender.user_id == tonumber(839738252) then
LuaTele.sendText(msg_chat_id,msg_id,"⋆ انت مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender.user_id == tonumber(839738252) then
LuaTele.sendText(msg_chat_id,msg_id,"⋆ انت مطور السورس يقلبي🌚♥","md",true)
...
if Redis:get(Mariam.."addchannel"..msg.sender.user_id) == "on" then
if text and text:match("^@[%a%d_]+$") then
local m , res = https.request("http://api.telegram.org/bot"..Token.."/getchat?chat_id="..text)
data = json:decode(m)
if res == 200 then
ch = data.result.id
Redis:set(Mariam.."chadmin"..msg_chat_id,ch) 
...
Redis:del(Mariam.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
if Redis:get(Mariam.."chadmin"..msg_chat_id) then
LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Mariam.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:get(Mariam.."chadmin"..msg_chat_id) then
Redis:del(Mariam.."chadmin"..msg_chat_id) 
...
Redis:set(Mariam.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(Mariam.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(Mariam.."Lock:text"..msg_chat_id,true) 
...
Redis:set(Mariam.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Mariam.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Mariam.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Mariam.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Mariam.."lockalllll"..msg_chat_id,"off")
...
Redis:set(Mariam.."lockalllll"..msg_chat_id,"on")
...
Redis:set(Mariam.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Mariam.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(Mariam.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Mariam..''..lock..msg_chat_id,"del")    
end
...
Redis:del(Mariam.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Mariam.."Lock:channell"..msg_chat_id)  
...
Redis:hset(Mariam.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(Mariam.."Lock:text"..msg_chat_id)  
...
Redis:del(Mariam.."Lock:Join"..msg_chat_id)  
...
Redis:del(Mariam.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Mariam.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(Mariam.."lockpin"..msg_chat_id)  
...
Redis:del(Mariam.."Lock:edit"..msg_chat_id) 
...
Redis:del(Mariam.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Mariam..''..lock..msg_chat_id)    
end
...
Redis:hset(Mariam.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Mariam.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Mariam.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Mariam.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Mariam.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Mariam.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Link"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(Mariam..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(Mariam..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(Mariam..'lock:Fshar'..msg.chat_id) 
...
Redis:del(Mariam..'lock:Fars'..msg.chat_id) 
...
Redis:set(Mariam.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Photo"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Video"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Animation"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:geam"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Audio"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:vico"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:forward"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Document"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Contact"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Spam"..msg_chat_id)  
...
Redis:set(Mariam.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Mariam.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Mariam.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Mariam.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Mariam.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Mariam.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(Mariam.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Mariam.."Status:Welcome"..msg_chat_id) then
...
Redis:del(Mariam.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(Mariam.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Mariam.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Mariam.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Mariam.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Mariam.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Mariam.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Mariam.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(Mariam.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Mariam.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Mariam..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Mariam..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ ارسل الان { ملصق ,متحركه ,صوره ,رساله }*',"md",true)  
end
...
Redis:set(Mariam.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Mariam.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Mariam.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Mariam.."All:Get:Reides:Commands:Group"..v)
Redis:del(Mariam.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Mariam.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Mariam.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Mariam.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Mariam.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Mariam.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Mariam.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✓ ❭' else Statuslink = '❬ ✗ ❭'
end
if Redis:get(Mariam.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✓ ❭' else StatusWelcome = '❬ ✗ ❭'
end
if Redis:get(Mariam.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✓ ❭' else StatusId = '❬ ✗ ❭'
end
if Redis:get(Mariam.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✓ ❭' else StatusIdPhoto = '❬ ✗ ❭'
end
if not Redis:get(Mariam.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if not Redis:get(Mariam.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✓ ❭' else StatusReplySudo = '❬ ✗ ❭'
end
if Redis:get(Mariam.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✓ ❭' else StatusBanId = '❬ ✗ ❭'
end
if Redis:get(Mariam.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✓ ❭' else StatusSetId = '❬ ✗ ❭'
end
if Redis:get(Mariam.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✓ ❭' else StatusGames = '❬ ✗ ❭'
end
if Redis:get(Mariam.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✓ ❭' else Statuskickme = '❬ ✗ ❭'
end
if Redis:get(Mariam.."Status:AddMe"..msg.chat_id) then
...
data = {
{
  {text = 'قناه السورس', url = 't.me/YYFNL'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Mariam.."Dev:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Mariam.."Creator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Mariam.."Manger:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Mariam.."Admin:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Mariam.."Special:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Mariam.."Dev:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Mariam.."Supcreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Mariam.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Mariam.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Mariam.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Mariam.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
if Redis:smembers(Mariam.."Supcreator:Group"..msg_chat_id) then
Redis:del(Mariam.."Supcreator:Group"..msg_chat_id) 
end
if Redis:smembers(Mariam.."Creator:Group"..msg_chat_id) then
Redis:del(Mariam.."Creator:Group"..msg_chat_id) 
end
if Redis:smembers(Mariam.."Manger:Group"..msg_chat_id) then
Redis:del(Mariam.."Manger:Group"..msg_chat_id) 
end
if Redis:smembers(Mariam.."Admin:Group"..msg_chat_id) then
Redis:del(Mariam.."Admin:Group"..msg_chat_id) 
end
if Redis:smembers(Mariam.."Special:Group"..msg_chat_id) then
Redis:del(Mariam.."Special:Group"..msg_chat_id) 
end
...
Redis:del(Mariam..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح تعديلاتي' or text == 'مسح تعديلاتي' then
Redis:del(Mariam..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Mariam..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد رسائلك هنا*~ '..(Redis:get(Mariam..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد التعديلات هنا*~ '..(Redis:get(Mariam..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد جهاتك المضافه هنا*~ '..(Redis:get(Mariam.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Mariam.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⋆ ارسل الان النص
⋆ يمكنك اضافه :
...
Redis:del(Mariam.."Set:Id:Groups")
...
Redis:setex(Mariam.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⋆ ارسل الان النص
⋆ يمكنك اضافه :
⋆ `#username` » اسم المستخدم
...
Redis:del(Mariam.."Set:Id:Group"..msg.chat_id)
...
Redis:del(Mariam.."klb:Group"..msg_chat_id) 
...
Redis:del(Mariam.."kholat:Group"..msg_chat_id) 
...
Redis:del(Mariam.."2rd:Group"..msg_chat_id) 
...
Redis:del(Mariam.."8by:Group"..msg_chat_id) 
...
Redis:del(Mariam.."3ra:Group"..msg_chat_id) 
...
Redis:del(Mariam.."smb:Group"..msg_chat_id) 
...
Redis:del(Mariam.."mar:Group"..msg_chat_id) 
...
Redis:del(Mariam.."twhd:Group"..msg_chat_id) 
...
Redis:del(Mariam.."wtka:Group"..msg_chat_id) 
...
Redis:del(Mariam.."ktmAll:Groups") 
...
Redis:del(Mariam.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(Mariam.."SilentGroup:Group"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Mariamb0t'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(Mariam.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Mariam.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Mariam.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Mariam.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) 
Redis:del(Mariam.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Mariam.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Photoc"..v..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Videoc"..v..msg_chat_id)  
Redis:del(Mariam.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Mariam.."Add:Rd:Manager:Audioc"..v..msg_chat_id)
Redis:del(Mariam.."List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود \n━━━━━━━━━━━━\n"
for k,v in pairs(list) do
if Redis:get(Mariam.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه •"
elseif Redis:get(Mariam.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه •"
elseif Redis:get(Mariam.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق •"
elseif Redis:get(Mariam.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله •"
elseif Redis:get(Mariam.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره •"
elseif Redis:get(Mariam.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو •"
elseif Redis:get(Mariam.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف •"
elseif Redis:get(Mariam.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه •"
elseif Redis:get(Mariam.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو •"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Mariam.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = 'الغاء الامر', data = msg.sender.user_id..'/cancelrdd'},},}}
...
if text then   
if Redis:get(Mariam..'Set:array'..msg.sender.user_id..':'..msg_chat_id) == 'true1' then
local test = Redis:get(Mariam..'Text:array'..msg.sender.user_id..':'..msg_chat_id..'')
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
Redis:sadd(Mariam.."Add:Rd:array:Text"..test..msg_chat_id,text)  
_key = {
...
if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'dttd' then
Redis:del(Mariam.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
gery = Redis:get(Mariam.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(Mariam.."Add:Rd:array:Text"..gery..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:srem(Mariam.."Add:Rd:array:Text"..gery..msg_chat_id,text)
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  تم حذفه بنجاح .* ',"md",true)
end
end
if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(Mariam.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(Mariam..'List:array'..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:set(Mariam.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id,text)
Redis:set(Mariam.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"dttd")
...
Redis:set(Mariam.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end

if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Set:array"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Mariam.."Set:array"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Mariam.."Text:array"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Mariam.."List:array"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Mariam.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id) == "delrd" then
Redis:set(Mariam.."Text:array"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Mariam.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:del(Mariam.."Add:Rd:array:Text"..text..msg_chat_id)
Redis:srem(Mariam..'List:array'..msg_chat_id, text)
...
Redis:set(Mariam.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
send_inlin_key(msg_chat_id,"⋆  ارسل الكلمه التي تريد حذفها",inlin,msg_id)
return false 
end
if text then
if  Redis:sismember(Mariam..'List:array'..msg_chat_id,text) then
local list = Redis:smembers(Mariam.."Add:Rd:array:Text"..text..msg_chat_id)
...
local list = Redis:smembers(Mariam..'List:array'..msg_chat_id..'')
...
local list = Redis:smembers(Mariam..'List:array'..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Mariam.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(Mariam..'List:array'..msg_chat_id)
end
...
Redis:set(Mariam.."Set:array"..msg.sender.user_id..":"..msg_chat_id,true)
return false
end
...
text = "\n⋆ قائمة الردود العامه \n•━─━─━─━─━─━─━─━•\n"
for k,v in pairs(list) do
if Redis:get(Mariam.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه ⋆"
elseif Redis:get(Mariam.."Add:Rd:Sudo:vico"..v) then
db = "بصمه ⋆"
elseif Redis:get(Mariam.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق ⋆"
elseif Redis:get(Mariam.."Add:Rd:Sudo:Text"..v) then
db = "رساله ⋆"
elseif Redis:get(Mariam.."Add:Rd:Sudo:Photo"..v) then
db = "صوره ⋆"
elseif Redis:get(Mariam.."Add:Rd:Sudo:Video"..v) then
db = "فيديو ⋆"
elseif Redis:get(Mariam.."Add:Rd:Sudo:File"..v) then
db = "ملف ⋆"
elseif Redis:get(Mariam.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ⋆"
elseif Redis:get(Mariam.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو ⋆"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Mariam..'GetTexting:DevMariam'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Mariam..'Texting:DevMariam')
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevMariam = Redis:get(Mariam..'Texting:DevMariam')
if TextingDevMariam then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevMariam,"md",true)  
else
...
if Redis:get(Mariam.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if text and Redis:get(Mariam..msg.chat_id.."name_mean"..msg.sender.user_id) == "true" then 
Redis:del(Mariam..msg.chat_id.."name_mean"..msg.sender.user_id)
...
Redis:set(Mariam..msg.chat_id.."name_mean"..msg.sender.user_id , true)
...
{{text = ' قناة السورس', url = "https://t.me/YYFNL"}},}}
...
local RinkBot = msg.Name_Controller
photo = "https://t.me/YYFNL/6"
local Name = '*- 𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘛𝘰 𝘚𝘰𝘶𝘳𝘤𝘦 Mariam.*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐃𝐞𝐯: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/STORM_MAX"},{text = '𝐂𝐡: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/YYFNL"},
},
{
{text = '𝐄𝐱𝐩 𝐒𝐨𝐮𝐫𝐜𝐞', url = "http://t.me/STORM_MAX"}
},
}
...
Redis:setex(Mariam.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Mariam.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(Mariam.."Name:Bot") or "مريم") then
local NamesBot = (Redis:get(Mariam.."Name:Bot") or "مريم")
local NameBots = {
"قلب "..NamesBot ,
"معاك",
"نعم ؟",
...
x = x + 1
Redis:srem(Mariam..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Mariam)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⋆ البوت عضو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره*',"md")
Redis:srem(Mariam..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Mariam..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Mariam..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Mariam..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Mariam.."Game:Smile"..msg.chat_id,SM)
...
Redis:set(Mariam.."mshaher"..msg.chat_id,name)
...
if Redis:get(Mariam.."Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","مريم","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","سونيك","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Mariam.."Game:Monotonous"..msg.chat_id,name)
...
name = string.gsub(name,"مريم","ر و ف ر ي")
...
Redis:set(Mariam.."Game:Riddles"..msg.chat_id,name)
...
if Redis:get(Mariam.."Status:Games"..msg.chat_id) then
Redis:del(Mariam.."Set:Country"..msg.chat_id)
...
Redis:set(Mariam.."Game:Countrygof"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Mariam.."Status:Games"..msg.chat_id) then
Redis:del(Mariam.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Mariam.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Mariam.."Status:Games"..msg.chat_id) then
Redis:del(Mariam.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Mariam.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(Mariam.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Mariam.."Game:Difference"..msg.chat_id,name)
...
Redis:set(Mariam.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Mariam.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Mariam.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
Redis:incrby(Mariam.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(Mariam.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Mariam.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:sadd(Mariam..'Num:User:Pv',msg.sender.user_id)  
if not msg.Devss then
if not Redis:get(Mariam.."Start:Bot") then
local CmdStart = '\n⋄︙مرحبا انا بوت '..(Redis:get(Mariam.."Name:Bot") or "مريم")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Mariam.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس مريم فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب أحصائيات  سورس مريم فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب المطورين لسورس مريم فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه بالاذاعه لسورس مريم فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه بالعام لسورس مريم فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ببوتك المثبت علئ لسورس مريم فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
--     Source Mariam     --
--     end start chat Pv     --
if text == 'تنظيف المشتركين ⋆' then
...
Redis:setex(Mariam.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(Mariam.."TwaslBot") and not Redis:sismember(Mariam.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Mariam.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Mariam.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Mariam..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⋆ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Mariam..'BaN:In:Tuasl',Info_User)  
...
reply_markup = {
inline_keyboard ={
{{text ="• Mariam Source", url= "https://t.me/YYFNL"}},
}
},
},
}
...
Redis:srem(Mariam.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Mariam..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Mariam.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(Mariam.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Mariam.."Mariam:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Mariam.."Mariam:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Mariam.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(Mariam) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Mariam..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == Mariam then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Mariam..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Mariam.."Lock:edit"..data.chat_id) then
...
if tonumber(IdUser) == 839738252 then
data.The_Controller = 1
elseif tonumber(IdUser) == 839738252 then
data.The_Controller = 1
elseif The_ControllerAll(IdUser) == true then  
data.The_Controller = 1
elseif Redis:sismember(Mariam.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(Mariam.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(Mariam.."Owners:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(Mariam.."Supcreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(Mariam.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(Mariam.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(Mariam.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(Mariam.."Special:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(Mariam) then
...
if Redis:sismember(Mariam.."Supcreator:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Supcreator:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Supcreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(Mariam.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Mariam.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Mariam.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Mariam.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(Mariam.."Creator:Group"..ChatId,UserId[2])
Redis:srem(Mariam.."Special:Group"..ChatId,UserId[2])
Redis:srem(Mariam.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(Mariam.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Mariam.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(Mariam.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Mariam.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local Info_Members = Redis:smembers(Mariam.."Owners:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Supcreator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Creator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Manger:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Admin:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Mariam.."Special:Group"..ChatId) 
if #Info_Members == 0 then
...
*]]
Redis:set(Mariam.."youtube"..IdUser..ChatId,'mp3')
...
if tonumber(IdUser) == tonumber(UserId[1]) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'سورس مريم', url = 't.me/YYFNL'}, },}}
local TextHelp = [[*⋆ ارسل اسم الفيديو من فضلك
⋆ Send Video Name Please*]]
Redis:set(Mariam.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local UserId = {Text:match('(%d+)/statusTheBasicsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Mariam.."Mariam:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Mariam:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Mariam:TheBasics:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusOriginatorsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(Mariam.."Mariam:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Mariam:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Mariam:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusManagersz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Mariam.."Mariam:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Mariam:Managers:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Mariam:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusAddictivez/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Mariam.."Mariam:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Mariam:Addictive:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Mariam:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusDistinguishedz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Mariam.."Mariam:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Mariam:Distinguished:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Mariam:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(Mariam.."Mariam:Originators:Group"..ChatId,UserId[2])
Redis:srem(Mariam.."Mariam:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(Mariam.."Mariam:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(Mariam.."Mariam:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if Redis:sismember(Mariam.."Mariam:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Mariam:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(Mariam.."Mariam:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'banned',0)
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
...
if Redis:sismember(Mariam.."Mariam:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Mariam.."Mariam:SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(Mariam.."Mariam:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:incrby(Mariam.."Num:Add:Games"..ChatId..IdUser, 1)  
...
Redis:set(Mariam.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناه السورس', url = 'https://t.me/YYFNL'}, },}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناه السورس', url = 'https://t.me/YYFNL'}, },}}
Redis:del(Mariam.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(Mariam.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(Mariam.."Set:array"..IdUser..":"..ChatId)
Redis:del(Mariam.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Mariam.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Mariam.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(Mariam.."Set:On"..IdUser..":"..ChatId)
...
if Redis:get(Mariam..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(Mariam..'Set:array'..IdUser..':'..ChatId)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ Mariam',url='http://t.me/YYFNL'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ Mariam',url='http://t.me/YYFNL'}},}
...
local TextHelp = [[*
⋆ أهلا بك في قائمة العاب سورس مريم اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{{text = 'قناه السورس', url = 't.me/YYFNL'}, },}}
local TextHelp = [[*
⋆ مرحبا بك في الالعاب المتطورة الخاص بسورس مريم
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 'https://t.me/YYFNL'}, },}}
local TextHelp = [[*• حسنا ارسل النص لترجمته الي العربيه*]]
Redis:set(Mariam.."toar"..IdUser,"on")
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
Redis:set(Mariam.."toen"..IdUser,"on")
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Mariam.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(Mariam.."ChekBotAdd",UserId[2])
Redis:set(Mariam.."Status:Id"..UserId[2],true) ;Redis:del(Mariam.."Status:Reply"..UserId[2]) ;Redis:del(Mariam.."Status:ReplySudo"..UserId[2]) ;Redis:set(Mariam.."Status:BanId"..UserId[2],true) ;Redis:set(Mariam.."Status:SetId"..UserId[2],true) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Mariam.."Owners:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Mariam.."Admin:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'تعط','تعطيل الايدي بالصوره')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"تعط")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'تفع','تفعيل الايدي بالصوره')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"تفع")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'ا','ايدي')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"ا")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'م','رفع مميز')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"م")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'اد', 'رفع ادمن')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"اد")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'مد','رفع مدير')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"مد")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'من', 'رفع منشئ')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"من")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'اس', 'رفع منشئ اساسي')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"اس")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'مط','رفع مطور')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"مط")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'ثانوي','رفع مطور ثانوي')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"ثانوي")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'تك','تنزيل الكل')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"تك")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'ر','الرابط')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"ر")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'رر','ردود المدير')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"رر")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'مسح المكتومين','ممكتومين')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"ممكتومين")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'رد','اضف رد')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"رد")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'سح','مسح سحكاتي')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"سح")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'رس','مسح رسائلي')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"رس")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'غ','غنيلي')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"غ")
Redis:set(Mariam.."Get:Reides:Commands:Group"..ChatId..":"..'#','مسح قائمه العام')
Redis:sadd(Mariam.."Command:List:Group"..ChatId,"#")
local txxt = [[
⋆ تم ترتيب الاوامر بالشكل التالي ~
⋆  ايدي - ا .
⋆  رفع مميز - م .
...
Mariamusername = '*تم الزواج بنجاح \nمبروك  يا  ↫ *['..bain.first_name..'](tg://user?id='..bain.id..' *\n*'
else
Mariamusername = 'لا يوجد'
end
LuaTele.editMessageText(ChatId,Msg_id,Mariamusername, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Mariam.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Mariam.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Mariam.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Mariam.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Mariam.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Mariam..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Mariam.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Supcreator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Owners:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Creator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Manger:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Admin:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."Special:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Mariam.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
